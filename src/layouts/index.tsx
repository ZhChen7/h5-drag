...
export default function Layout({ children }: IRouteComponentProps) {
  ...
  const [render, setList] = useRegister(
    ...
    {},
    <div>
      welcome!欢迎使用h5-drag，你有任何问题，都可以咨询我哦～
      <div style={{ paddingTop: '10px', marginTop: '10px', borderTop: '1px solid #f0f0f0' }}>
        <div>【dooring指南】</div>
        <div>
          <div>
            &nbsp;&nbsp;1.{' '}
            <a href="https://github.com/MrXujiang/h5-drag" target="_blank">
              h5-drag源码地址
            </a>
          </div>
          <div>
            &nbsp;&nbsp;2.{' '}
            <a href="https://github.com/MrXujiang/h5-drag/graphs/contributors" target="_blank">
              贡献者列表
            </a>
          </div>
          <div>
